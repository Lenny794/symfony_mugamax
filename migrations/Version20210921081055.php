 ...
 */
final class Version20210921081055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE actuality_comment (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, actuality_news_id INT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_3CD18099A76ED395 (user_id), INDEX IDX_3CD180991D018B55 (actuality_news_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
